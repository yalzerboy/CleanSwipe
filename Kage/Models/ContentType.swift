...
enum StorageAvailability: String, CaseIterable {
    case none = "None – please help!"
    case lessThan1GB = "< 1 GB"
    case moreThan1GB = "1 GB or more"
}

enum ICloudStorageStatus: String, CaseIterable {
    case yes = "Yes"
    case no = "No"
    case notSure = "Not sure"
}

enum StorageImpactExperience: String, CaseIterable {
    case yes = "Yes"
    case no = "No"
    case notSure = "Not sure"
}
